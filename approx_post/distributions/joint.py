...
class ModelPlusGaussian(JointDistribution):
    ...
    def _create_logpdf(self):
        ...
        def logpdf(theta, x, d):
            ...
            x_pred = self._model_funcs['model'](theta, d) # shape = (num_batch, num_samples, x_dim)
    ...
    def _create_logpdf_del_1(self):
        ...
        def logpdf_del_1(theta, x, d):
            ...
            mean_del_theta = self._model_funcs['model_grad'](theta, d) # shape = (num_batch, num_samples, x_dim, theta_dim)
